  ...
  \section{Scala}
    ...
    \subsection{Previous Work}
      ...
      \subsubsection{Reactive}
        Arguably the most significant of these is the library `reactive' created by `nafg'. This framework was 
...
\end{verbatim}
        ...
        In fact, it can be seen that a Signal[T] can however be represented in terms
        of the `switcher' function:
...
\end{verbatim} 
      ...
      of an FRP Behaviour as it only allows for a subset of a Behaviour's functionality.
