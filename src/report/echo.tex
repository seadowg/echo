...
\end{verbatim}          
  ...
  \section{Problems and Caveats}
    ...
    \subsection{Events as Monotonic Streams}
      ...
      % Reiterate that events are infinite streams
      % Occurrence times are monotonic
      % Occurrences are real-time streaming data
      % Map time example (genereate occurrence in past)
    
    \subsection{Events are Infinite}
    
      % Event operating carried out on infinite data set
      % Only needed to know until fixed finite point
