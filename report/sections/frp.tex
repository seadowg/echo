...
def lift1[T, U](func : T => U, beh) : Behaviour[U]
at(lift1(func, beh), t) = func(at(beh))

def lift2[T, U, V](func : (T, U) => V, beh1 : T, beh2 : U) : Behaviour[V]
...
\end{verbatim}
    ...
    \subsection{Events are Infinite}  
      ...
      It should be noted however that as the times in Event occurrences are monotonically increasing
