\chapter{Evaluation}    
  ...
  \section{Efficiency}
    ...
    There is a minor inefficiency due to the choice to make the \emph{occur} and \emph{eval} objects atomic for
    with respect to all the FRP objects for an application. This means that even if two Behaviours are in no way
    related they cannot be read concurrently. It can be seen that in many application the FRP objects will
