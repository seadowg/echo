...
\end{verbatim}
  ...
  \section{Efficiency}
    ...
    Behaviours
    and this further leads to a more optimised implementation of FRP. In a similar vein Echo does redundantly recompute
    values for Behaviours lifted from constants. This allows for an efficient implementation of \emph{stepper} that
    doesn't evaluate its current phase on each phase (it simply returns the phase's value).
