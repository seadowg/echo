\chapter{Previous Implementations}
  ...
  \section{Haskell}
    ...
    \subsection{Reactive}
      ...
      Reactive introduces a new way to represent what he referred to as
...
\end{verbatim}
      ...
      We can then think of a Reactive's as a value that changes at discrete points in time (denoted by the
      elements of the stream). Elliott points out that we can also express Behaviour's implementation in this way also:
