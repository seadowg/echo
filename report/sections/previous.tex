\chapter{Previous Implementations}
  ...
  \section{Haskell}
    ...
    \subsection{Reactive}
      % Developed by Conal Elliott as a research project
      % Subject of the paper Push-pull
      % Motivated by inefficiency in having to poll Behaviours
      % Refines and optimises semantics with underlying Future and Reactive types (without altering Behaviour/Event)
      % Implementation has all features but is reportedly buggy
      % Doesn't remove polling problem as Behaviours still exist
...
\section{Comparison}
  ...
  \begin{center}
     \begin{tabular}{ | l | l | l | l | l | }
       \hline
        & Reactive & Reactive-Banana & Reactive & React \\ \hline \hline
